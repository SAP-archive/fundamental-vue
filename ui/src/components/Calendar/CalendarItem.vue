...
const CalendarItemModifiers = Object.keys(
  calendarItemModifierMapping
) as CalendarItemModifier[];
const CalendarItemModifierValidator = (value: any): boolean =>
...
const CalendarItemStates = Object.keys(
  calendarItemStateMapping
) as CalendarItemState[];
const CalendarItemStatesValidator = (value: any): boolean =>
...
export default Vue.extend({
  ...
  props: {
    ...
    modifier: {
      ...
      default: null
    } as PropValidator<CalendarItemModifier | null>,
    state: {
      type: String,
      validator: CalendarItemStatesValidator,
      default: null
    } as PropValidator<CalendarItemState | null>
  },
  computed: {
    classes(): string[] {
