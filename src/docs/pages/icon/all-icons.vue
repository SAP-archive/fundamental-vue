<template>
  <div>
    <div class="fdd-icons--all-icons">
      <FdLayoutGrid :col="5" style="box-sizing: border-box;">
        <FdLayoutGridItem v-for="icon in icons" :key="icon">
          <FdTile isButton class="fdd-icons--all-icons--tile" @click="$copyText(icon)">
            <FdIdentifier
...
.fdd-icons--all-icons--tile {
  border: 1px solid #cfcfcf;
}

.fdd-icons--all-icons--tile:hover {
